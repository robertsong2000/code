...
kernel_code	dw 0xFFFF
		dw 0x0000
		db 0x00
		dw ACC_GRANULARY | ACC_DEF32SIZE | (1111b * ACC_LIMIT_MUL) | \
		   ACC_PRESENT | ACC_DPL_RING0 | ACC_TYPE_CODE | \
...
kernel_data	dw 0xFFFF
		...
		db 0x00
		dw ACC_GRANULARY | ACC_DEF32SIZE | (1111b * ACC_LIMIT_MUL) | \
		   ACC_PRESENT | ACC_DPL_RING0 | ACC_TYPE_DATA | \
...
real_mode_code	dw 0xFFFF
		dw 0x0000
		db KERNEL_START_HI
		dw ACC_PRESENT | ACC_DPL_RING0 | ACC_TYPE_CODE | \
		   ACC_TYPE_READ | ACC_USERSEG
		db 0x00
...
real_mode_data	dw 0xFFFF
		dw 0x0000
		db KERNEL_START_HI
		dw ACC_PRESENT | ACC_DPL_RING0 | ACC_TYPE_DATA | \
		   ACC_TYPE_WRITE | ACC_USERSEG
		db 0x00
...
task_code	dw 0x0000
		dw 0x0000
		db 0x00
		dw ACC_GRANULARY | ACC_DEF32SIZE | (0000b * ACC_LIMIT_MUL) | \
		   ACC_PRESENT | ACC_DPL_RING0 | ACC_TYPE_CODE | \
		   ACC_TYPE_READ | ACC_USERSEG
		db 0x00
