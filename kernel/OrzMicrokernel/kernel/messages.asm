...
Int_SendMessageWkrnl:
	...
	jmp SysCall_Sleep
Sc0:
	cmp eax, msg_GetTickCount
	jnz Sc1
	jmp SysCall_GetTickCount
Sc1:
	cmp eax, msg_FindTaskByName
	jnz Sc2
	jmp SysCall_FindTaskByName
Sc2:
	cmp eax, msg_RmodeInt
	jnz Sc3
	jmp SysCall_RmodeInt
Sc3:
	cmp eax, msg_GetScanCode
	jnz Sc4
	jmp SysCall_GetScanCode
Sc4:
	cmp eax, msg_EnumTasksID
	jnz Sc5
	jmp SysCall_EnumTasksID
Sc5:
	cmp eax, msg_GetTaskName
	jnz Sc6
	jmp SysCall_GetTaskName
Sc6:
	cmp eax, msg_KillTask
	jnz Sc7
